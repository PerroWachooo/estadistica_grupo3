...
```
Como se puede apreciar el mejor modelo es el "modelo_simple2", por lo que se procedera a verificar las condiciones para generalizar dicho modelo

las condiciones son: 
1.- debe existir correlacion lineal entre los predictores y la respuesta transformada
2.- los residuos deben ser independientes 

ademas de estas condiciones se revisara que no exista multicolinealidad.
